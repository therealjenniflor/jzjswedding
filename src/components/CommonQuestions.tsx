...
const faqs = [
  {
    ...
    a: "A Save the Date is an early announcement letting you know you're invited to our wedding. The Save the Date text we send IS your invitation — there is no separate formal invite coming.\n\nIf Jennifer or Jhonatan sent you this link directly, you are on our guest list and we are so excited to celebrate with you. When we officially send out Save the Dates, the text will include the names of everyone in your party who is invited. From there, an RSVP link will follow so you can confirm your attendance.",
    aes: 'Un Save the Date es un aviso anticipado que te hace saber que estás invitado/a a nuestra boda. El mensaje de texto del Save the Date que enviaremos ES tu invitación — no habrá una invitación formal por separado.\n\nSi Jennifer o Jhonatan te enviaron este enlace directamente, estás en nuestra lista de invitados y estamos muy emocionados de celebrar contigo. Cuando enviemos oficialmente los Save the Dates, el mensaje de texto incluirá los nombres de todos en tu grupo que están invitados. Después de eso, llegará un enlace para confirmar tu asistencia.'
  },
  {
    num: '02',
